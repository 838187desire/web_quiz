const questions = [
    ...
    },
    {
        ...
        Explanation: "<i class='fa-solid fa-angles-right icon'></i> यह तत्पुरुष समास का एक उपभेद है। इसमें पहला पद 'अ', 'अन्', 'न' जैसे नकारात्मक (निषेधवाचक) उपसर्ग होता है, जो दूसरे पद के अर्थ का निषेध करता है।"
    },
    {
