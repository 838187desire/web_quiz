const questions = [    
    ...
    {
        question: "'हित + ईश' की संधि से क्या शब्द बनेगा?",
        answers: shuffle([
            { text: "हितईश", correct: false },
            { text: "हितेश", correct: true },
            { text: "हितैश", correct: false },
            { text: "हितीश", correct: false }
        ]),
        Explanation: "<i class='fa-solid fa-angles-right icon'></i> गुण संधि के नियमानुसार, जब 'अ' के बाद 'ई' आता है, तो दोनों मिलकर 'ए' (ए) हो जाते हैं। अतः, 'हित' के 'अ' और 'ईश' के 'ई' के मेल से 'हितेश' बनता है"
    },
    {
