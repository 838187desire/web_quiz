const questions = [
    {
        topHeading: "प्रागैतिहासिक काल पर आधारित बहुविकल्पीय प्रश्न part 7 (quiz_no.7)"
    },
    {
        ...
        Explanation: "<i class='fa-solid fa-angles-right icon'></i> पुरापाषाण काल को निम्न पुरापाषाण काल (Lower Paleolithic), मध्य पुरापाषाण काल (Middle Paleolithic), और उच्च पुरापाषाण काल (Upper Paleolithic) में विभाजित किया गया है।"
    },
    {
    ...
    {
        question: "'मध्यपाषाण काल' की 'आग्नेय संस्कृति' (Fire Culture) का प्रमाण कहाँ से मिला है?",
        answers: shuffle([
    ...
    {
        question: "'जली हुई हड्डियाँ' किस मध्यपाषाण कालीन स्थल से मिली हैं?",
        answers: shuffle([
        ...
        Explanation: "<i class='fa-solid fa-angles-right icon'></i> उत्तर प्रदेश के सराय नाहर राय से कुछ जली हुई हड्डियाँ मिली हैं, जो इस बात का संकेत देती हैं कि यहाँ अग्नि का उपयोग शवों को जलाने के लिए भी किया जाता था।"
    },
    {
    ...
    },
    {
        ...
        Explanation: "<i class='fa-solid fa-angles-right icon'></i> इनामगाँव (महाराष्ट्र) से बड़ी संख्या में मनके बनाने के अवशेष और मनके बनाने के कारखाने मिले हैं।"
    },
    {
    ...
    {
        question: "'कायथा संस्कृति' किस नदी के किनारे स्थित थी?",
        answers: shuffle([
    ...
    {
        question: "'ताम्रपाषाण संस्कृति' का कौन सा पुरास्थल 'अन्नागार' (Granary) के लिए प्रसिद्ध है?",
        answers: shuffle([
            { text: "इनामगाँव", correct: true },
            { text: "नवदाटोली", correct: false },
            { text: "कायथा", correct: false },
    ...
    {
        question: "'महापाषाण संस्कृति' का प्रमुख केंद्र कहाँ था?",
        answers: shuffle([
            { text: "गंगा घाटी", correct: false },
            { text: "नर्मदा घाटी", correct: false },
            { text: "दक्षिण भारत", correct: true },
