const questions = [
    {
        topHeading: "विलोम शब्द पर आधारित 50 बहुविकल्पीय प्रश्न part 1 (quiz_no.37)"
    },
    {
    ...
    {
        question: "'मुख्य' का विलोम शब्द क्या है?",
        answers: shuffle([
            { text: "प्रधान", correct: false },
            { text: "आवश्यक", correct: false },
            { text: "गौण", correct: true },
            { text: "प्रमुख", correct: false }
        ]),
        Explanation: "<i class='fa-solid fa-angles-right icon'></i> 'मुख्य' का अर्थ है प्रमुख या प्रधान।<br><br><i class='fa-solid fa-angles-right icon'></i> इसका विलोम 'गौण' है, जिसका अर्थ है जो कम महत्वपूर्ण हो।"
    },
    {
        ...
        Explanation: "<i class='fa-solid fa-angles-right icon'></i> 'राजा' का अर्थ है शासक, जो धनवान और शक्तिशाली होता है।<br><br><i class='fa-solid fa-angles-right icon'></i> इसका विलोम 'रंक' है, जिसका अर्थ है अत्यंत निर्धन व्यक्ति।"
    },
    {
