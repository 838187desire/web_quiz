const questions = [
    ...
    {
        question: "'सम् + भाव' की संधि से बनने वाला शब्द है:",
        answers: shuffle([
            { text: "संभावना", correct: true },
            { text: "संभ", correct: false },
            { text: "संभाव", correct: false },
            { text: "संभाओ", correct: false }
        ]),
        Explanation: "<i class='fa-solid fa-angles-right icon'></i> 'म्' के बाद 'भ्' (प-वर्ग का चौथा वर्ण) आने पर 'म्' का 'म्' ही रहता है और अनुस्वार में बदल जाता है (प-वर्ग का पाँचवाँ वर्ण)।"
    },
    {
    ...
    },
    {
        ...
        answers: shuffle([
            ...
            { text: "संधी", correct: true },
            { text: "संद्धि", correct: false },
            { text: "सनधी", correct: false }
        ]),
        Explanation: "<i class='fa-solid fa-angles-right icon'></i> 'म्' के बाद 'ध्' (त-वर्ग का चौथा वर्ण) आने पर 'म्' का 'न्' हो जाता है (त-वर्ग का पाँचवाँ वर्ण), जिससे 'संधी' बनता है।<br><br><i class='fa-solid fa-angles-right icon'></i> 'संधि' वर्तनी भी मान्य है।"
    },
    {
