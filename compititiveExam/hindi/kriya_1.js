const questions = [
    ...
    },
    {
        ...
        answers: shuffle([
            ...
            { text: "सहायक क्रिया", correct: true },
            { text: "संयुक्त क्रिया", correct: false },
            { text: "नामधातु क्रिया", correct: false }
        ]),
        Explanation: "<i class='fa-solid fa-angles-right icon'></i> इस वाक्य में कोई मुख्य क्रिया नहीं है, 'हैं' सहायक क्रिया के रूप में प्रयोग हुआ है।"
    },
    {
