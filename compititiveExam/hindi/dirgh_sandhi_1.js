const questions = [
    ...
    {
        question: "'कविंद्र' का सही संधि विच्छेद क्या है?",
        answers: shuffle([
    ...
    {
        question: "'वधु + उत्सव' की संधि से बनने वाला शब्द है:",
        answers: shuffle([
        ...
        Explanation: "<i class='fa-solid fa-angles-right icon'></i> दीर्घ संधि के नियम के अनुसार, 'उ' के बाद 'उ' आने पर दोनों मिलकर 'ऊ' हो जाते हैं।<br><br><i class='fa-solid fa-angles-right icon'></i> अतः, 'वधूत्सव' बनता है।"
    },
    {
